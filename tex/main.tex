...
Through the len of MMSE estimator, our work provides a theoretical framework to analyze the CNNs in the context of imaging inverse problems. While being tractable and interpretable, our derived closed-form LE-MMSE offers valuable insights into the behavior of these networks under various settings.
Our analysis also leverages the strength of neural networks by revealing their ability to compress large datasets into their considerably smaller number of parameters, then rearticulate efficiently the parameters in the inference phase, enabling fast and low-computational inference, explaining their practical success.
Moreover the strongly quantitative and qualitative agreement between our theoretical formulas and trained neural networks across various settings validates our approach and land a step towards demystifying the CNNs.  
